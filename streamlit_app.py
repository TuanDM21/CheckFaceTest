...
def main():
    ...
    def recognize_faces(image, landmarks, known_face_encodings):
        ...
        for face_encoding in face_encodings:
            matches = face_tool.compare_faces(known_face_encodings, face_encoding, tolerance=0.6)
    ...
    camera1, camera2 = cv2.VideoCapture(2), cv2.VideoCapture(2)
    ...
    while True:
        ...
        frame_count += 1
        # print("thread 1, ", input_queue1.qsize())
        # print("thread 1, ", output_queue1.qsize())
        # print("thread 2, ", input_queue2.qsize())
        # print("thread 2, ", output_queue2.qsize())
        fps.update()
