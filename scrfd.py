...
class SCRFD:
    def __init__(
        self,
        model_file: str = 'pretrain_model/scrfd_10g_bnkps.onnx',
    ...
    def filter(self, scores_list, bboxes_list, kpss_list, input_size,theshold_w,theshold_h):
        ...
        for i, bbox_obj in enumerate(bboxes_list):
            ...
            if len(list_kps) == 0:
                continue
            new_bboxes_list.append(list_box)
            new_kpss_list.append(list_kps)
            new_scores_list.append(list_score)
        return new_scores_list, new_bboxes_list, new_kpss_list

    def detect(self, img, thresh=0.2, input_size=(640, 640), max_num=0, metric='default',threshold_w=0.3,threshold_h=0.2):
        ...
        scores_list, bboxes_list, kpss_list = self.filter(scores_list, bboxes_list, kpss_list, input_size,threshold_w,threshold_h)
